...
description: "Aurora full-stack engineer. Implements storefront and command-center surfaces, the fake-data layer, and API routes. The one who types."
model: sonnet
