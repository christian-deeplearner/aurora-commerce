// The editorial home — the showpiece. Mirrors thegaochao.vercel.app in Aurora
// tokens: a full-bleed dark hero melting into paper with an oversized serif
// statement; THE COLLECTIONS as hairline-separated rows; a two-column POSITION
// manifesto; the notify footer (in the layout). Server Component — reads the
// data-layer directly.
  ...
  return (
    <div className="bg-paper">
      ...
      <section className="relative isolate overflow-hidden bg-panel text-paper-on-panel">
        ...
        <img
          src="https://picsum.photos/seed/aurora-hero-dawn/2000/1400"
          alt=""
          aria-hidden
        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-7xl flex-col justify-end px-6 pb-20 pt-32 sm:px-10 sm:pb-28">
          ...
          <p className="serif mt-8 max-w-xl text-xl text-paper-on-panel/80">
            Six collections, one source of light. Unstructured tailoring, hand-
            dyed gradients, and objects measured in small radiances.
          </p>
          <div className="mt-10">
            <Link
              href="/collections"
      ...
      <section className="mx-auto max-w-7xl px-6 pt-24 sm:px-10 sm:pt-32">
        <div className="flex items-end justify-between px-0 sm:px-10">
          ...
          <span className="label label-muted">
            {String(collections.length).padStart(2, "0")} lines of light
          </span>
        </div>
      </section>
        ...
        <div className="grid gap-12 md:grid-cols-12 md:gap-16">
          ...
          <div className="md:col-span-8">
            <p className="display text-3xl text-ink sm:text-4xl md:text-5xl">
              Light is not a color. It is a way of holding attention — generous,
              unhurried, and certain of itself.
            </p>
            <div className="mt-12 grid gap-10 sm:grid-cols-2">
              <p className="serif text-lg text-ink-muted">
                We design for the full arc of a day. Halo for the first hour,
                Umbra for what the light leaves behind, and four collections for
                everything the sun touches in between.
              </p>
              <p className="serif text-lg text-ink-muted">
                Everything here is fictional — a teaching house of light, seeded
                with invented goods. The craft is real; the catalog is a story
                we tell to show how a calm, premium store is built.
              </p>
            </div>
          </div>
        </div>
