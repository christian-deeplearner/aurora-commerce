...
export const metadata = { title: "Agents — Aurora Command" };
  ...
  return (
    <div className="flex flex-col gap-10">
      <PageHeader
        ...
        description="The harness, made legible. These are the repo's own Claude Code agents and decision log — read live from disk, so the context that builds Aurora is visible inside it."
      />
