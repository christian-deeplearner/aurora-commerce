...
// A curated set of "Aurora customer" cities — feels like an international
// editorial DTC base rather than random faker noise.
const CITIES = [
  "Brooklyn, NY",
  "Los Angeles, CA",
  "Austin, TX",
...
function buildCustomers(): Customer[] {
  return Array.from({ length: CUSTOMER_COUNT }, () => {
    ...
    const email = faker.internet
      .email({ firstName, lastName, provider: "aurora-demo.test" })
      .toLowerCase();
