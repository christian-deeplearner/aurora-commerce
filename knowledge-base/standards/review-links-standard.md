...
```
Built the Meridian collection page.
- Route: app/(store)/collections/meridian/page.tsx
- One product per view, full-bleed hero, on-voice one-liner (PDP gate 88/100)
Review: http://localhost:3000/collections/meridian   (mobile: resize to 390px — verified)
