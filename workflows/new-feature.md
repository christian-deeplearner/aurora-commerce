...
A sequence-and-gate workflow for adding a surface or feature to Aurora. Phases are ordered; each gate is **binary**. The `director` runs it; owners are agents from `.claude/agents/`.
